...
`])),_),U=j()(M.Flex)(p||(p=S()([`
  ...
  `,`
`])),function(z){return z.theme.colors.neutral600},.625,function(z){return z.theme.colors.primary600},F.a),P=l.a.forwardRef(function(z,X){var I=z.children,B=z.startIcon,A=z.endIcon,H=z.onClick,W=z.disabled,E=z.loading,G=g()(z,L),V=H&&!W?H:void 0,R=W||E;return l.a.createElement(U,d()({ref:X,"aria-disabled":R,onClick:V,as:"button",type:"button"},G),(B||E)&&l.a.createElement(s.Box,{as:"span",paddingRight:2,"aria-hidden":!0},E?l.a.createElement(Q,null,l.a.createElement(r.a,null)):B),l.a.createElement(k.Typography,{variant:"pi",textColor:R?"neutral600":"primary600"},I),A&&l.a.createElement(s.Box,{as:"span",paddingLeft:2,"aria-hidden":!0},A))});P.displayName="TextButton",P.defaultProps={disabled:!1,startIcon:void 0,endIcon:void 0,loading:!1,onClick:void 0},P.propTypes={children:b.a.node.isRequired,disabled:b.a.bool,endIcon:b.a.element,loading:b.a.bool,onClick:b.a.func,startIcon:b.a.element}}])})},89881:(y,C,h)=>{var x=h(47816),v=h(99291),m=v(x);y.exports=m},69199:(y,C,h)=>{var x=h(89881),v=h(98612);function m(t,f){var e=-1,o=v(t)?Array(t.length):[];return x(t,function(i,p,u){o[++e]=f(i,p,u)}),o}y.exports=m},82689:(y,C,h)=>{var x=h(29932),v=h(97786),m=h(67206),t=h(69199),f=h(71131),e=h(7518),o=h(85022),i=h(6557),p=h(1469);function u(d,c,g){c.length?c=x(c,function(a){return p(a)?function(l){return v(l,a.length===1?a[0]:a)}:a}):c=[i];var O=-1;c=x(c,e(m));var S=t(d,function(a,l,w){var b=x(c,function(T){return T(a)});return{criteria:b,index:++O,value:a}});return f(S,function(a,l){return o(a,l,g)})}y.exports=u},71131:y=>{function C(h,x){var v=h.length;for(h.sort(x);v--;)h[v]=h[v].value;return h}y.exports=C},26393:(y,C,h)=>{var x=h(33448);function v(m,t){if(m!==t){var f=m!==void 0,e=m===null,o=m===m,i=x(m),p=t!==void 0,u=t===null,d=t===t,c=x(t);if(!u&&!c&&!i&&m>t||i&&p&&d&&!u&&!c||e&&p&&d||!f&&d||!o)return 1;if(!e&&!i&&!c&&m<t||c&&f&&o&&!e&&!i||u&&f&&o||!p&&o||!d)return-1}return 0}y.exports=v},85022:(y,C,h)=>{var x=h(26393);function v(m,t,f){for(var e=-1,o=m.criteria,i=t.criteria,p=o.length,u=f.length;++e<p;){var d=x(o[e],i[e]);if(d){if(e>=u)return d;var c=f[e];return d*(c=="desc"?-1:1)}}return m.index-t.index}y.exports=v},99291:(y,C,h)=>{var x=h(98612);function v(m,t){return function(f,e){if(f==null)return f;if(!x(f))return m(f,e);for(var o=f.length,i=t?o:-1,p=Object(f);(t?i--:++i<o)&&e(p[i],i,p)!==!1;);return f}}y.exports=v},89734:(y,C,h)=>{var x=h(21078),v=h(82689),m=h(5976),t=h(16612),f=m(function(e,o){if(e==null)return[];var i=o.length;return i>1&&t(e,o[0],o[1])?o=[]:i>2&&t(o[0],o[1],o[2])&&(o=[o[0]]),v(e,x(o,1),[])});y.exports=f}}]);
